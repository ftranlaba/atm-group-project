...
-- -----------------------------------------------------
-- Table `mydb`.`debit_card_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`debit_card_transactions` (
  ...
  INDEX `fk_debit_card_transactions_debit_cards1_idx` (`id_card` ASC) VISIBLE,
  CONSTRAINT `fk_debit_card_transactions_debit_cards1`
    FOREIGN KEY (`id_card`)
    REFERENCES `mydb`.`debit_cards` (`id_card`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`credit_card_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`credit_card_transactions` (
  `id_transaction` INT NOT NULL AUTO_INCREMENT,
  `id_card` INT NOT NULL,
  `time` TIMESTAMP NOT NULL,
  `merchant_name` VARCHAR(45) NOT NULL,
  `cost` INT NOT NULL,
  PRIMARY KEY (`id_transaction`),
  INDEX `fk_credit_card_transactions_credit_cards1_idx` (`id_card` ASC) VISIBLE,
  CONSTRAINT `fk_credit_card_transactions_credit_cards1`
    FOREIGN KEY (`id_card`)
    REFERENCES `mydb`.`credit_cards` (`id_card`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
