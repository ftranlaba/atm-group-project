...
CREATE TABLE IF NOT EXISTS `mydb`.`accounts` (
  ...
  INDEX `fk_accounts_users1_idx` (`id_user` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`transfers` (
  ...
  `old_balance_acc1` DECIMAL NOT NULL,
  `new_balance_acc1` DECIMAL NOT NULL,
  `old_balance_acc2` DECIMAL NOT NULL,
  `new_balance_acc2` DECIMAL NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`deposit_withdraw_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`deposit_withdraw_history` (
  `id_history` INT NOT NULL AUTO_INCREMENT,
  `id_account` INT NOT NULL,
  `time` TIMESTAMP NOT NULL,
